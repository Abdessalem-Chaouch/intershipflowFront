                    ...
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-12 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            <div class="mb-8 flex items-center justify-center gap-3">
                                <span class="font-extrabold text-5xl tracking-widest text-[#063970] dark:text-blue-200">SIGA</span>
                            </div>
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <p-button label="S'inscrire" styleClass="w-full" routerLink="/auth/login"></p-button>
